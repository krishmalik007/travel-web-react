  ...
  const packageDetails = {
    ...
    "Kerala": [
      {
        ...
        image: "/images/img 1.avif", // Replace with actual image URL
      ...
      },
      {
        ...
        image: "/images/img 2.jpg", // Replace with actual image URL
    ...
    "Australia": [
      {
        ...
        description: "2N Munnar - 1N Thekkady - 1N Alleppey",
        image: "/images/img 28.jpg", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "8 Activities", "Intercity Car Transfers"],
        duration: "4N/5D"
      },
      {
        ...
        description: "1N Cochin - 2N Munnar - 1N Thekkady - 1N Alleppey",
        image: "/images/img 29.webp", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "9 Activities", "Intercity Car Transfers"],
        duration: "5N/6D"
      }
    ],
    "Europe": [
      {
        ...
        description: "2N Munnar - 1N Thekkady - 1N Alleppey",
        image: "/images/img 30.webp", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "8 Activities", "Intercity Car Transfers"],
        duration: "4N/5D"
      },
      {
        ...
        description: "1N Cochin - 2N Munnar - 1N Thekkady - 1N Alleppey",
        image: "/images/img 31.jpg", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "9 Activities", "Intercity Car Transfers"],
        duration: "5N/6D"
      }
    ],
    "Azerbaijan": [
      {
        ...
        description: "2N Munnar - 1N Thekkady - 1N Alleppey",
        image: "/images/img 32.avif", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "8 Activities", "Intercity Car Transfers"],
        duration: "4N/5D"
      },
      {
        ...
        description: "1N Cochin - 2N Munnar - 1N Thekkady - 1N Alleppey",
        image: "/images/img 33.webp", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "9 Activities", "Intercity Car Transfers"],
        duration: "5N/6D"
      }
    ],
    "Bali": [
      {
        ...
        description: "2N Munnar - 1N Thekkady - 1N Alleppey",
        image: "/images/img 26.avif", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "8 Activities", "Intercity Car Transfers"],
        duration: "4N/5D"
      },
      {
        ...
        description: "1N Cochin - 2N Munnar - 1N Thekkady - 1N Alleppey",
        image: "/images/img 16.webp", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "9 Activities", "Intercity Car Transfers"],
        duration: "5N/6D"
      }
    ],
    "Canaves Oia Epitome": [
      {
        ...
        description: "2N Munnar - 1N Thekkady - 1N Alleppey",
        image: "/images/img 9.jpg", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "8 Activities", "Intercity Car Transfers"],
        duration: "4N/5D"
      },
      {
        ...
        description: "1N Cochin - 2N Munnar - 1N Thekkady - 1N Alleppey",
        image: "/images/img 10.jpg", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "9 Activities", "Intercity Car Transfers"],
        duration: "5N/6D"
      }
    ],
    ...
    "Goa": [
      {
        ...
        image: "/images/img 3.webp", // Replace with actual image URL
      ...
      },
      {
        ...
        image: "/images/img 4.jpg", // Replace with actual image URL
    ...
    "Manali": [
      {
        ...
        image: "/images/img 5.jpg", // Replace with actual image URL
        features: ["Round Trip Flights", "Luxury Resorts", "8 Activities", "Beach Transfers"],
        duration: "4N/5D"
      },
      {
        ...
        image: "/images/img 6.jpeg", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "10 Activities", "Intercity Car Transfers"],
        duration: "5N/6D"
      }
    ],
    "Delhi": [
      {
        ...
        image: "/images/img 7.webp", // Replace with actual image URL
        features: ["Round Trip Flights", "Luxury Resorts", "8 Activities", "Beach Transfers"],
        duration: "4N/5D"
      },
      {
        ...
        image: "/images/img 7.jpeg", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "10 Activities", "Intercity Car Transfers"],
        duration: "5N/6D"
      }
    ],
    "Kolkata": [
      {
        ...
        image: "/images/img 8.jpg", // Replace with actual image URL
        features: ["Round Trip Flights", "Luxury Resorts", "8 Activities", "Beach Transfers"],
        duration: "4N/5D"
      },
      {
    ...
    "Shimla": [
      ...
      },
      {
        ...
        image: "/images/img 11.jpg", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "10 Activities", "Intercity Car Transfers"],
        duration: "5N/6D"
      }
    ],
    "Bangalore": [
      {
        ...
        image: "/images/img 12.jpg", // Replace with actual image URL
        features: ["Round Trip Flights", "Luxury Resorts", "8 Activities", "Beach Transfers"],
        duration: "4N/5D"
      },
      {
        ...
        image: "/images/img 13.webp", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "10 Activities", "Intercity Car Transfers"],
        duration: "5N/6D"
      }
    ],
    "Hyderabad": [
      {
        ...
        image: "/images/img 14.jpg", // Replace with actual image URL
        features: ["Round Trip Flights", "Luxury Resorts", "8 Activities", "Beach Transfers"],
        duration: "4N/5D"
      },
      {
        ...
        image: "/images/img 15.webp", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "10 Activities", "Intercity Car Transfers"],
        duration: "5N/6D"
      }
    ],
    "Udaipur": [
      ...
      },
      {
        ...
        image: "/images/img 17.jpg", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "10 Activities", "Intercity Car Transfers"],
        duration: "5N/6D"
      }
    ],
    "Mumbai": [
      {
        ...
        image: "/images/img 18.jpg", // Replace with actual image URL
        features: ["Round Trip Flights", "Luxury Resorts", "8 Activities", "Beach Transfers"],
        duration: "4N/5D"
      },
      {
        ...
        image: "/images/img 19.jpg", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "10 Activities", "Intercity Car Transfers"],
        duration: "5N/6D"
      }
    ],
    "Pune": [
      {
        ...
        image: "/images/img 20.jpg", // Replace with actual image URL
        features: ["Round Trip Flights", "Luxury Resorts", "8 Activities", "Beach Transfers"],
        duration: "4N/5D"
      },
      {
        ...
        image: "/images/img 21.jpg", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "10 Activities", "Intercity Car Transfers"],
        duration: "5N/6D"
      }
    ],
    "Rishikesh": [
      {
        ...
        image: "/images/img 22.jpg", // Replace with actual image URL
        features: ["Round Trip Flights", "Luxury Resorts", "8 Activities", "Beach Transfers"],
        duration: "4N/5D"
      },
      {
        ...
        image: "/images/img 23.webp", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "10 Activities", "Intercity Car Transfers"],
        duration: "5N/6D"
      }
    ],
    "Jaipur": [
      {
        ...
        image: "/images/img 24.webp", // Replace with actual image URL
        features: ["Round Trip Flights", "Luxury Resorts", "8 Activities", "Beach Transfers"],
        duration: "4N/5D"
      },
      {
        ...
        image: "/images/img 25.jpeg", // Replace with actual image URL
        features: ["Round Trip Flights", "5 Star Hotels", "10 Activities", "Intercity Car Transfers"],
        duration: "5N/6D"
      }
    ],
    "Agra": [
      {
        ...
        image: "/images/img 27.cms", // Replace with actual image URL
        features: ["Round Trip Flights", "Luxury Resorts", "8 Activities", "Beach Transfers"],
        duration: "4N/5D"
      },
      {
  ...
  return (
    <>
      ...
      <div className="place-container">
        <h1>{placeName}</h1>
        <p style={{ fontSize: '20px', marginTop: '8px', color: '#4b5563' }}>
          Welcome to {placeName}! Here are some amazing vacation packages you
          can explore:
        </p>
